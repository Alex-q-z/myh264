...
struct x264_t
{
    ...
    int enable_print_flag;
    FILE* residual_matrix_fptr;
    FILE* tmp_fptr;
    int current_qp;
    int counter_tmp;
    //FILE* qp_matrix_fptr;
    int* qp_matrix;
    int* chroma_qp_matrix;
    int* error_bound_matrix;
    int* mb_size_matrix;
    int* error_matrix;
    int mb_encode_flag;
    int mb_counter;
    ...
    // file pointers
    FILE* operation_mode_file;
    FILE* qp_matrix_file;
    FILE* qp_matrix_file_test;
    
    /* 
        Qizheng: operation mode flag 
        0: universal single qp encoding mode
        1: universal error bound restriction mode
    */
    int operation_mode_flag;
    int universal_qp;
    int universal_chroma_qp;
    int universal_error_bound;
    int universal_error_bound_u;
    int universal_error_bound_v;
    int universal_error_bound_rgb;
    // for bw test on 7/17
    int num_groups;
    int start_qp;
...
#define FDEC_STRIDE 32
        ...
        // QIZHENG: my own fields
        int     i_error; /* current error */
        int     y_error; /* y channel error */
        int     u_error; /* u channel error */
        int     v_error; /* v channel error */
        int     rgb_error; /* RGB error (approximation) */
        int     lb; /* for binary search */
        int     rb; /* for binary search */
        int     mb_counter;
