...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-libx264 --enable-gpl --enable-shared --disable-x86asm --prefix=/tank/qizheng/ --extra-cflags=-I/tank/qizheng/codec_project/x264/x264 --extra-ldflags=-I/tank/qizheng/codec_project/x264/x264
prefix=/tank/qizheng/
...
CFLAGS=  -I/tank/qizheng/codec_project/x264/x264 -std=c11 -fomit-frame-pointer -fPIC -pthread  -DX264_API_IMPORTS -I/tank/qizheng//include -I/usr/include/alsa     -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized -D_REENTRANT -I/usr/include/SDL2
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/tank/qizheng/codec_project/x264/x264 -fPIC -g
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -I/tank/qizheng/codec_project/x264/x264  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-pthread -lm -llzma -lz -L/tank/qizheng//lib -lx264
