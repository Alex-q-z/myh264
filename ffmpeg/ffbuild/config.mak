...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-libx264 --enable-gpl --enable-shared
prefix=/usr/local
...
EXTRALIBS-avcodec=-liconv -lm -llzma -lz -framework AudioToolbox -L/usr/local/lib -lx264 -pthread -framework VideoToolbox -framework CoreFoundation -framework CoreMedia -framework CoreVideo -framework CoreServices
