...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-libx264 --enable-gpl --enable-shared --disable-x86asm --prefix=/tank/kuntai/ --extra-cflags=-I/tank/kuntai/myh264/x264 --extra-ldflags=-I/tank/kuntai/myh264/x264
prefix=/tank/kuntai/
...
CFLAGS=  -I/tank/kuntai/myh264/x264 -std=c11 -fomit-frame-pointer -fPIC -pthread -DX264_API_IMPORTS -I/tank/kuntai//include -D_REENTRANT -I/usr/include/SDL2  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/tank/kuntai/myh264/x264 -fPIC -g
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -I/tank/kuntai/myh264/x264  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lXv -lX11 -lXext -lSDL2 -lSDL2 -lxcb -lxcb-shm -lxcb-xfixes -lxcb-shape -lsndio -lasound -lSDL2 -L/tank/kuntai//lib -lx264 -lm -ldl -llzma -lbz2 -lz -pthread -pthread 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
